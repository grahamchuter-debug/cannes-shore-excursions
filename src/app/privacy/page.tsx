...
export const metadata = buildMetadata({
  ...
  description: "Privacy policy for Cannes Shore Excursions — how we handle information submitted through our enquiry form and site analytics.",
  path,
  noindex: true,
});
...
export default function PrivacyPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Privacy Policy", description: "Privacy policy for Cannes Shore Excursions.", path })]} />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="prose-body">
            ...
            <h2>Who we are</h2>
            <p>{SITE.name} ({SITE.url}) is an independent Cannes cruise planning resource. This policy explains what information we collect and how we use it.</p>
