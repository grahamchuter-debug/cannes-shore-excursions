...
export const metadata = buildMetadata({
  title: "Cannes Cruise Ship Schedules",
  description:
    "Cannes cruise ship schedules by year and month. See which ships are in port before booking Monaco Magic, Riviera excursions or Cannes walking days — ready for CSV schedule imports.",
  path,
  keywords: ["Cannes cruise ship schedule", "Cannes cruise calendar", "Gare Maritime cruise schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Cannes Cruise Ship Schedules", description: "Cannes cruise ship schedules by year and month.", path })]} />
      <PageHero title="Cannes Cruise Ship Schedules" subtitle="See which ships are in port before you book excursions. Year and month views are ready for schedule imports — times are indicative until data is loaded." compact />
