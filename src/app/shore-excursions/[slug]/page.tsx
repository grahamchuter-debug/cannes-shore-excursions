    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {isPremium && (
            <>
              <div className="mt-10 card-editors-choice">
                ...
                <p className="mt-2 text-sm text-gray-600">Our editorial team compared ship tours, DIY options and independent operators before naming Monaco Magic Editor&apos;s Choice — not marketing, but the excursion we would genuinely suggest.</p>
                <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-gray-700">
                  {e.whyWeRecommend!.map((x) => <li key={x}>{x}</li>)}
                </ul>
                <Link href="/why-monaco-magic-is-our-editors-choice" className="btn-secondary mt-4 inline-flex text-sm">Read our full editorial reasoning</Link>
              </div>
          ...
          <div className="mt-8 card-accent">
            <h2 className="font-display text-xl font-bold text-gray-900">Port logistics from Gare Maritime</h2>
          ...
          {relatedGuides.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">Related comparisons &amp; guides</h2>
