...
export const metadata = buildMetadata({
  title: "Cannes Shore Excursions",
  description:
    "Cannes shore excursions for cruise passengers — Monaco Magic (Editor's Choice), French Riviera highlights, Nice & Eze, luxury experiences, Cannes walking days and future private, food and wine tours.",
  path: "/shore-excursions",
  image: excursionsHubImage.src,
  imageAlt: excursionsHubImage.alt,
  keywords: ["Cannes cruise excursions", "Monaco shore excursion from Cannes", "Monaco Magic", "French Riviera shore excursions"],
});
...
export default function ShoreExcursionsPage() {
  ...
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Cannes Shore Excursions", description: "Premium Cannes shore excursions for cruise passengers.", path: "/shore-excursions" })]} />
      <PhotoHeroBand
        image={excursionsHubImage}
        eyebrow="French Riviera tours"
        title="Cannes Shore Excursions"
        subtitle="Independent, passenger-first recommendations — Monaco Magic is our Editor's Choice, but we compare every option honestly so you choose the right Riviera day for your port window."
        compact
      />
        ...
        <div className="container-wide">
          ...
          {editorsChoice && (
            <div className="mb-10 card-editors-choice max-w-4xl">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <Link href={`/shore-excursions/${editorsChoice.slug}`} className="btn-primary text-sm">View Monaco Magic</Link>
                <Link href="/why-monaco-magic-is-our-editors-choice" className="btn-secondary text-sm">Why we recommend it</Link>
                <Link href="/monaco-magic-vs-cruise-line-excursion" className="btn-secondary text-sm">Compare with ship tours</Link>
              </div>
            </div>
          )}
          ...
          <div className="mb-10 card-feature max-w-3xl">
            <p className="text-sm text-gray-700 leading-relaxed">
              Future products — private Riviera tours, shared small-group tours, luxury experiences, food tours, wine experiences and Provence excursions — will appear here as they launch. Browse options below and <Link href="/enquire" className="font-semibold text-coastal-700 hover:underline">register your interest</Link> or enquire about Monaco Magic.
            </p>
          </div>
