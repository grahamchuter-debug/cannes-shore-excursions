...
export const metadata = buildMetadata({
  title: "Terms of Use",
  description: "Terms of use for Cannes Shore Excursions — the basis on which we provide our French Riviera cruise planning guides and information.",
  path,
  noindex: true,
});
...
export default function TermsPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Terms of Use", description: "Terms of use for Cannes Shore Excursions.", path })]} />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="prose-body">
            ...
            <p>{SITE.name} provides planning information and guidance for cruise passengers calling at Cannes on the French Riviera. It is offered in good faith for general guidance and does not constitute professional travel advice.</p>
