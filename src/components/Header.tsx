      ...
      <div className="container-wide flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="hidden sm:block">
            <div className="font-display text-lg font-bold text-coastal-800 leading-tight">Cannes Shore</div>
            <div className="text-xs text-gray-500 -mt-0.5">Excursions &amp; Riviera</div>
          </div>
        </Link>
