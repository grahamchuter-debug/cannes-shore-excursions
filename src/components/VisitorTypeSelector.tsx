  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide">
        ...
        <h2 className="section-title mt-2">What kind of Cannes cruise passenger are you?</h2>
        <p className="section-subtitle">Choose the option that fits your French Riviera port day and we&apos;ll point you to the right planning resources.</p>
